...
### Tiempo respecto a Edad

```{r, fig.height=3}
ggplot(CarreraLuz22, aes(x = edad, y = timerun/60)) +
  geom_point(color="green") +
  labs(x = "Edad",
       y = "Tiempo de carrera (min)") +
...
x=dataFc2$edad
hist(x, xlim=c(10,80), ylim=c(0,250),las=1,
main = " ",
xlab="Edad",
ylab = "Frecuencia",
col ="#FF00FF")
...
### Frecuencia hombres por edad

```{r}
# seleccion de bases
dataMc2=subset(CarreraLuz22, (CarreraLuz22$sex=="Hombre")) # dataset de mujeres
x=dataMc2$edad
hist(x, xlim=c(10,80), ylim=c(0,250),las=1,
main = " ",
xlab="Edad",
